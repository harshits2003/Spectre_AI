...
def GoogleSearch(query):
    ...
    Answer = f"The searhc results for '{query}' are:\n[start]\n"
...
#Predefined chatbot conversation system and an initial user message
SystemChatBot = [
...
def Information():
    ...
    data += f"Use this real-time informatikon if needed:\n"
    data += f"Day: {day}\nDate: {date}\nMonth: {month}\nYear: {year}\n"
    data += f"Time: {hour} hours: {minute} minutes: {second} seconds.\n"
    return data

#Function to handle reaal-time search and response generation.
